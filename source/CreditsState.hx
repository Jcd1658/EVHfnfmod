...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['EVH Team'],
			['ThatOneCupid', 'none', 'Mod Creator/Charter', 'https://www.youtube.com/channel/UCOvgLyADlnRA_GjfXGxeCLw/featured', '9E51FF'],
			['Swiffzz', 'none', 'Mod Artist', 'https://www.youtube.com/channel/UCHBIA6smUJUnJ6qqy8vlFOg', '8AFF7C'],
			['Bacon', 'none', 'Mod Coder', '', '53E52C'],
			['agmas', 'none', 'Mod Coder', 'https://www.youtube.com/watch?v=qYN8yVBWCo4', 'FFFFFF'],
			['yelloguy', 'none', 'Artist', '', 'FFBB1B'],
			['Troll_Man', 'none', '.. Being Hitler?', 'https://twitter.com/0TrollGuy0', '46D000'],
			...
			['JayD', 'none', 'Eminem Vocals', 'https://www.youtube.com/channel/UC2dUkG2-HNdYIy8o3LaO2Tg', '626262'],
			...
			['Some Sans mod', 'none', 'Press enter to see - Charts', 'https://gamebanana.com/mods/348631', 'FFFFFF'],
			[''],
			['Psych Engine Team'],
